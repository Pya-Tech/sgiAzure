...
{
    /// <summary>
    /// Interfaz que define las propiedades y comportamientos de un objeto de procesamiento de mensajes.
    /// </summary>
    public interface IMessageProcessing
    {
        ...
        /// <summary>
        /// Obtiene o establece la fecha y hora en que se actualizó el registro de procesamiento del mensaje, si aplica.
        /// </summary>
        ...
        /// <summary>
        /// Obtiene el objeto de relación
        /// </summary>
        RequirementWorkItem? RequirementWorkItem { get; set; }
    }
}
