...
{
    public interface IWorkItemRequirementInsertConsumer<T> where T : IRequirement
    {
        /// <summary>
        ...
        Task ConsumeAsync(string queueName, T requirement, CancellationToken cancellationToken);
    }
}
