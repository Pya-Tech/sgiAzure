using ServiceHook.Domain.Interfaces.Entities;

namespace ServiceHook.Domain.Entities
{
    /// <summary>
    /// Representa un WorkItem en Azure DevOps.
    /// Contiene todas las propiedades necesarias para modelar un WorkItem, incluyendo su identificación, detalles, asignaciones, y fechas clave.
    /// </summary>
