...
namespace ServiceHook.Api.Models
{
    public partial class ResourceFields
    {
        ...
        [JsonPropertyName("Custom.ReportType")]
        [JsonConverter(typeof(FieldSerialization))]
        public Field? CustomReportType { get; set; }
        ...
        [JsonConverter(typeof(FieldSerialization))]
        public Field? CustomBugType { get; set; }

        [JsonPropertyName("Custom.FeatureType")]
        [JsonConverter(typeof(FieldSerialization))]
        public Field? CustomFeatureType { get; set; }

        [JsonPropertyName("Custom.TaskType")]
        [JsonConverter(typeof(FieldSerialization))]
        public Field? CustomTaskType { get; set; }
