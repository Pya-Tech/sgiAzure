...
call dbms_java.grant_permission( 'GEN_BROKER', 'SYS:java.net.SocketPermission', '172.18.0.3:15672', 'connect,resolve' );
call dbms_java.grant_permission( 'GEN_BROKER', 'SYS:java.net.SocketPermission', '172.18.0.3:5672', 'connect,resolve' );
